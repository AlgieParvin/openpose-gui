...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.output_button, 1, 4, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)
        self.output_line_edit = QtWidgets.QLineEdit(self.centralwidget)
        self.output_line_edit.setStyleSheet("output_line_edit.setStyleSheet(\"QLineEdit { border-radius: 5px; }\")")
        self.output_line_edit.setObjectName("output_line_edit")
        self.gridLayout.addWidget(self.output_line_edit, 1, 1, 1, 3)
        ...
        self.horizontalLayout_2.setContentsMargins(-1, 18, -1, 12)
        ...
        self.horizontalLayout_2.addWidget(self.dark_bg_check_box)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.output_button.setText(_translate("MainWindow", "Выбрать"))
        self.label_2.setText(_translate("MainWindow", "Сохранить как:"))
